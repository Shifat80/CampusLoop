      ...
      <div className="fixed bottom-0 left-0 right-0 z-50">
        <div className="min-w-[375px] max-w-md mx-auto bg-white border-t border-gray-200 shadow-lg">
          <div className="grid grid-cols-5 py-2">
            {/* Home */}
            <button className="flex flex-col items-center justify-center py-2 text-gray-600 hover:text-[#00bba7] transition-colors">
            ...
            {/* Profile */}
            <button className="flex flex-col items-center justify-center py-2 hover:text-[#00bba7] transition-colors">
